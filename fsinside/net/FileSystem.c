...
//////////////////////////////////////////////////////////////////////
	...
	InodeBitmap_t ibm;
	ibm.size = FS_INODE_COUNT / 8; /*byte*/ 
	memcpy(ibm.InodeBitmap, fileSysInfo.pInodeBitmap, ibm.size);
	...
	BlockBitmap_t bbm;
	bbm.size = dataRegionSize / 8;	/*byte*/
	memcpy(bbm.BlockBitmap, fileSysInfo.pBlockBitmap, bbm.size);
	printf("[]size = %d\n", bbm.size);
